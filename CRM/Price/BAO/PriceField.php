      ...
      case 'Radio':
        ...
        foreach ($customOption as $opId => $opt) {
          ...
          if (in_array($opId, $feezeOptions)) {
            ...
            $choice[$opId]->setText('&nbsp;<span class="sold-out-option">Sold out</span>&nbsp;' . $choice[$opId]->getText());
          }
        }
      ...
      case 'CheckBox':
        ...
        foreach ($customOption as $opId => $opt) {
          ...
          if (in_array($opId, $feezeOptions)) {
            $check[$opId]->freeze();
            // CRM-14696 - Improve display for sold out price set options
            $check[$opId]->setText('&nbsp;<span class="sold-out-option">Sold out</span>&nbsp;' . $check[$opId]->getText());
          }
        }
